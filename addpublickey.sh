...
ssh ssingh28@192.168.1.12 'if [ ! -d /home/ssingh0/.ssh ];
then sudo mkdir /home/ssingh0/.ssh   
echo "created new .ssh folder"
else echo ".ssh folder exists"
fi' 

ssh ssingh28@192.168.1.12 'if [ ! -e /home/ssingh0/.ssh/authorized_keys ];
...
publickey=$(cat "id_rsa2.pub") 
ssh ssingh28@192.168.1.12 "if sudo grep -q '$publickey' </home/ssingh0/.ssh/authorized_keys;
