	...
	ssh access_server@$1 "sudo sh -c '> /home/$2/.ssh/authorized_keys;grep -v -f /home/access_server/$3  /home/$2/.ssh/authorized_keys; > /home/$2/.ssh/authorized_keys; rm /home/access_server/$3'";
